  ...
  return (
    <section className="bg-white dark:bg-black mt-16 w-full overflow-x-hidden border-b border-zinc-300 dark:border-zinc-800">
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-32 lg:px-12 overflow-x-hidden">
        ...
        <h1 className="mb-4 text-4xl font-bold tracking-normal  text-zinc-900 md:text-5xl lg:text-7xl dark:text-white max-w-screen-lg mx-auto font-owners">
        ...
        <p className='uppercase font-light py-2 pb-6 tracking-wider'>Connect. Revolutionize. Innovate. Boost.</p>
        <p className="mb-8 text-lg font-normal text-zinc-500 lg:text-xl sm:px-16 xl:px-48 dark:text-zinc-300 max-w-screen-lg mx-auto">Here at CRIB we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
        <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
          <a href="#" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-black dark:text-white rounded-sm bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
            Learn more
            <svg className="ml-2 -mr-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
          </a>
          <div onClick={handleOpenModal} className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-zinc-900 rounded-sm border border-zinc-300 hover:bg-zinc-100 focus:ring-4 focus:ring-zinc-100 dark:text-white dark:border-zinc-700 dark:hover:bg-zinc-700 dark:focus:ring-zinc-800">
        ...
        <div className="hidden px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
