...
import { AlchemyLogo, MicrosoftLogo } from "../../Components/SvgLogos";
  ...
  return (
    <section className="relative mt-16 w-full overflow-hidden border-b border-zinc-300 dark:border-zinc-800">
      ...
      <div className="relative py-24 px-4  mx-auto max-w-screen-xl text-center lg:py-32 lg:px-12 overflow-x-hidden">
        <a
          href="#"
          className="hidden justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-zinc-700 bg-zinc-100 rounded-full dark:bg-zinc-800 dark:text-white hover:bg-zinc-200 dark:hover:bg-zinc-700"
          role="alert"
        >
        ...
        <h1 className="mb-4 text-4xl font-medium tracking-normal  md:text-5xl lg:text-7xl text-white max-w-screen-lg mx-auto font-owners">
        ...
        <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
          <Link
            href={content?.url || "/about"}
            className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-sm bg-primary-700 hover:bg-primary-800 focus:ring-2 focus:ring-red-200 "
          >
            Learn more
            <svg
          ...
          <div
            ...
            className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center rounded-sm border border-zinc-300 hover:bg-zinc-100 focus:ring-4 focus:ring-zinc-100 text-white  hover:text-black "
          >
            <svg
              className="w-7 pr-2"
              fill="none"
        ...
        <div className="px-4 pt-8 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
          ...
          <div className="flex flex-wrap justify-center items-center mt-8 text-zinc-500 sm:justify-around max-w-sm mx-auto">
            <Link
              ...
              className=" mr-5 mb-5 lg:mb-0 hover:text-zinc-800 dark:hover:text-zinc-400"
            >
              <MicrosoftLogo />
            </Link>
