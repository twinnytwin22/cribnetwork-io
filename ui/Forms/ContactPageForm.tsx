      ...
      >
        ...
        <div className="flex space-x-3">
          ...
          <Link href={bookingUrl}>
            <button className="py-3 font-owners px-5 tracking-wide text-xs md:text-sm font-medium text-center text-black bg-red-300 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 hover:scale-105">
              Schedule a Call{" "}
            </button>
          </Link>
        </div>
