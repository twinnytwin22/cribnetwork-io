...
export const getExistingDocs = async () => {
 ...
 export const forceRerender = async (setMounted: any) => {
    setMounted(false);
    requestAnimationFrame(() => setMounted(true));
  };


export const saveToDB = async (editorRef: any, savedContent: string,id?: any) => {
    try {
...
export const log = (editorRef, savedContent, setSavedContent) => {
