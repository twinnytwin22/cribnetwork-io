      ...
      <header className="mb-4 lg:mb-6 not-format">
        <address className="flex items-center mb-6 not-italic justify-between">
          <div className="inline-flex items-center mr-3 text-sm text-zinc-900 dark:text-white">
            <img
              className="mr-4 w-16 h-16 rounded-full hidden"
            ...
            <div>
              ...
              <p className="text-base text-zinc-500 dark:text-zinc-400"></p>
            </div>
          </div>
          <div
            onClick={() => setShowShare(true)}
            className="text-black dark:text-white mt-6 text-3xl hover:scale-105 duration-200 ease-in-out cursor-pointer"
          >
            <BsShare />
          </div>
        </address>
        <h2 className="my-12 text-3xl font-extrabold leading-tight text-zinc-900 lg:mb-6 lg:text-4xl ei dark:text-white">
          {post?.title}
        </h2>
      </header>
      <Image
        ...
        width={1000}
        height={600}
        className="aspect-video object-cover rounded-lg my-12 shadow-lg"
      />
