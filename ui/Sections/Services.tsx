...
function Services() {
    return (
        <div id="services" className='py-24 w-full px-2.5 md:px-8 mx-auto bg-white dark:bg-black border-b border-zinc-300 dark:border-zinc-800'>
            <h1 className="mb-4 md:mb-12 text-3xl md:text-4xl lg:text-5xl text-center  font-extrabold tracking-normal  text-zinc-900  dark:text-white max-w-screen-lg mx-auto font-owners">
