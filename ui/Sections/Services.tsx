...
function Services() {
    return (
        <div id="services" className='py-24 w-full bg-white dark:bg-black border-b border-zinc-300 dark:border-zinc-800'>
            ...
            <div className='grid grid-cols-1  md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 text-center sm:text-left px-4 gap-16 place-items-start max-w-screen-xl w-full mx-auto text-zinc-900 dark:text-zinc-200'>
