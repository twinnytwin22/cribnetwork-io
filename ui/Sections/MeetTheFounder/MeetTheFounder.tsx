      ...
      <div className="md:grid md:grid-cols-2 max-w-7xl mx-auto text-zinc-600 dark:text-zinc-300 place-items-center">
        ...
        <div className="space-y-8">
          ...
          <Link className="" href="https://www.linkedin.com/in/randalherndon/">
            <div className="bg-blue-700 hover:bg-blue-800 duration-200 ease-in-out p-2 px-4 mt-8 rounded w-56 font-sm justify-around font-owners mx-auto text-white flex items-center space-x-2">
