    ...
    <div className="border p-8 rounded-md mt-20 border-zinc-300 dark:border-zinc-900">
      <form onSubmit={handleSubmit} className="mt-8">
        <div className="flex flex-col">
          <label
            htmlFor="description"
            className="text-zinc-800 dark:text-white font-bold pb-2"
          >
            Item description
          </label>
          <input
        ...
        <button type="submit" className="btn-primary mt-6">
          {isEditing ? (
            ...
            <div className="flex gap-2">
              <div className="items-center bg-black rounded-md text-white w-6 h-6">
                +
              </div>
              Table Item
            </div>
      ...
      <table width="100%" className="mt-10 mb-10 overflow-auto">
        <thead>
          <tr className="bg-zinc-100 dark:bg-zinc-800 p-1">
            <td className="font-bold text-zinc-800 dark:text-white">
              Description
            </td>
            <td className="font-bold text-zinc-800 dark:text-white">
              Quantity
