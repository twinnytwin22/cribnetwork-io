      ...
      <div className="mt-4">
        ...
        <ul className="text-black dark:text-white justify-center mx-auto w-max  md:min-w-[165px] lg:min-w-[210px] text-sm">
          <li className="flex items-center space-x-3">
            <BsStopwatch />
            <p className="text-zinc-800 dark:text-zinc-300">Course Duration</p>
          </li>
          <li className="flex items-center space-x-3">
            <BiMicrochip />
            <p className="text-zinc-800 dark:text-zinc-300">Modules</p>
          </li>
          <li className="flex items-center space-x-3">
            <FaSchoolCircleCheck />
            <p className="text-zinc-800 dark:text-zinc-300">Enrolled</p>
          </li>
        </ul>
      </div>
