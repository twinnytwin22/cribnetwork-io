...
function FormSubmissionsWrapper({ children, formTypes }: { children: React.ReactNode, formTypes: any }) {
    const {
        previewOpen,
        selectAll,
        setSelectAll,
    ...
    useHandleOutsideClick(formTypeInputOpen, setFormTypeInputOpen, 'form-type-input')
                ...
                <SubmissionPreview />
                    ...
                    {formTypeInputOpen &&
                        <div className='space-y-4'>
                            ...
                            <input
                                className="bg-zinc-50 border border-zinc-300 form-type-input text-zinc-900 text-sm rounded-lg focus:ring-red-300 focus:border-red-300 block w-full  p-2 dark:bg-zinc-950 dark:border-zinc-600 dark:placeholder-zinc-400 dark:text-white dark:focus:ring-red-300 dark:focus:border-red-300" placeholder="Add new form type..." required
                                autoComplete='off'
                                value={newFormType}
                            ...
                            <button
                                ...
                                onClick={handleCreateFormType}>Create</button>

                        </div>
                    }
                    {filterMenuOpen && 
                    
                    <FilterMenu formTypes={formTypes}/>}
