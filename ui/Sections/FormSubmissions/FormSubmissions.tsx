...
function FormSubmissions({ data, formTableProps, formTypes }) {
    const { previewOpen, selectAll, setSelectAll, setPreviewOpen, setSelectedSubmission, selectedFormTypes, setSelectedFormTypes, setFilteredSubmissions, filteredSubmissions, setFilterMenuOpen, filterMenuOpen } = useFormSubmissionTableStore()
                ...
                <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    ...
                    <div className="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                        ...
                        <div className="flex items-center space-x-3 w-full md:w-auto">
                            ...
                            <div id="actionsDropdown" className="hidden z-10 w-44 bg-white rounded divide-y divide-zinc-100 shadow dark:bg-zinc-950 dark:divide-zinc-600">
