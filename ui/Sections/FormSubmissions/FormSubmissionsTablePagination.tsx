...
function FormSubmissionsTablePagination() {
  return (
    <ul className="inline-flex items-stretch -space-x-px">
      ...
      <li>
        <Link
          href="#"
          className="flex items-center justify-center text-sm py-2 px-3 leading-tight text-zinc-500 bg-white border border-zinc-300 hover:bg-zinc-100 hover:text-zinc-700 dark:bg-zinc-800 dark:border-zinc-700 dark:text-zinc-400 dark:hover:bg-zinc-700 dark:hover:text-white"
        >
          1
        </Link>
      </li>
...
export default FormSubmissionsTablePagination;
