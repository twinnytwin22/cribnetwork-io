...
function FormSubmissionsTable({ data, tableHeaders }) {
  return (
    ...
    {data?.map((submission: any) => (
        <tr key={submission.id} className="border-b dark:border-zinc-700">
            ...
            <td className="px-4 py-3 flex items-center justify-end">
                <button id="apple-imac-27-dropdown-button" data-dropdown-toggle="apple-imac-27-dropdown" className="inline-flex items-center p-0.5 text-sm font-medium text-center text-zinc-500 hover:text-zinc-800 rounded-lg focus:outline-none dark:text-zinc-400 dark:hover:text-zinc-100" type="button">
                <BsChevronCompactDown/>

                </button>
                <div id="apple-imac-27-dropdown" className="hidden z-10 w-44 bg-white rounded divide-y divide-zinc-100 shadow dark:bg-zinc-700 dark:divide-zinc-600">
                    <ul className="py-1 text-sm text-zinc-700 dark:text-zinc-200" aria-labelledby="apple-imac-27-dropdown-button">
                        <li>
