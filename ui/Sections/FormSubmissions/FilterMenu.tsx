...
function FilterMenu({ formTypes }) {
  ...
  return (
    <div
      id="filterDropdown"
      className="filter-menu z-[60]  w-full p-3 rounded-lg top-14 right-0 "
    >
      <h6 className="mb-3 text-sm font-medium text-zinc-900 dark:text-white">
        Choose Type
      </h6>
      <ul className="space-y-2 text-sm " aria-labelledby="filterDropdownButton">
        <li className="flex items-center">
          ...
          <label
            htmlFor="selectAll"
            className="ml-2 text-sm font-medium text-zinc-900 dark:text-zinc-100"
          >
            Select All
          </label>
        </li>
