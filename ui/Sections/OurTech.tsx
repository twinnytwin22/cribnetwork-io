...
function OurTech() {
  return (
    <div
      id="tech"
      className="w-full py-32 bg-zinc-100 dark:bg-zinc-950 border-b border-zinc-300 dark:border-zinc-800"
    >
        ...
        <div className="flex flex-col space-y-10 w-full mb-12 text-zinc-900 dark:text-zinc-300">
          <Link href="https://www.prns.app/" className="space-y-2 w-full ">
            <Image
              ...
              height={100}
            />
            <p className="w-40 text-center text-sm mx-auto">
              Administration and education tools for pro musicians.
            </p>
          </Link>
          <Link
            href="https://subport.xyz"
            className="w-full mx-auto flex-col flex"
          >
            ...
            <p className="w-40 text-center text-sm mx-auto">
              Marketing and promotion tools for independent creators.
            </p>
          </Link>
        </div>
        <div>
          <h1 className="text-4xl md:text-5xl font-medium font-owners mb-4 text-black dark:text-white">
            Our Technology
          </h1>
