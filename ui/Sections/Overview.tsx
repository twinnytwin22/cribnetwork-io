            ...
            <div className='grid md:grid-cols-2 w-full place-items-center max-w-screen-2xl mx-auto py-24 '>
                <div className='w-full max-w-lg px-4'>
                    ...
                    <ul className='space-y-4 text-black dark:text-white'>
                        <li className='flex p-4 rounded-sm  dark:bg-black bg-white space-x-3 items-center'>
                            ...
                            <p className='mb-2 text-xl font-bold dark:text-white font-[owners]'>Software / Web Development</p>
                        </li>
                        <li className='flex p-4 rounded-sm dark:bg-black bg-white  space-x-3 items-center'>
                            ...
                            <p className='mb-2 text-xl font-bold dark:text-white font-[owners]'>Digital Marketing</p>
                        </li>
                        <li className='flex p-4 rounded-sm dark:bg-black bg-white  space-x-3 items-center'>
                            ...
                            <p className='mb-2 text-xl font-bold dark:text-white font-[owners]'>Media Publishing</p>
                        </li>
                    </ul>
