            ...
            <tbody className="bg-white divide-y divide-zinc-200 dark:bg-black">
              {users.map((user) => (
                <tr key={user.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">{user.avatar_url || "---"}</td>
                  <td className="px-6 py-4 whitespace-nowrap">{user.billing_address || "---"}</td>
                  <td className="px-6 py-4 whitespace-nowrap">{user.payment_method || "---"}</td>
