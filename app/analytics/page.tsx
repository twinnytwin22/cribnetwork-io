      ...
      <div className="h-full">
        <div className="p-4 md:p-10 mx-auto max-w-7xl">
          <Grid
            numItemsSm={2}
            numItemsLg={3}
            className="gap-6 text-black dark:text-white"
          >
            {data.map((item) => (
              <div
                key={item.category}
                className="bg-white dark:bg-black p-4 border border-zinc-300 dark:border-zinc-800 rounded"
              >
                ...
                <Flex
                  ...
                  className="space-x-2"
                >
                  <Metric className="text-black dark:text-white">
                    {item.stat}
                  </Metric>
