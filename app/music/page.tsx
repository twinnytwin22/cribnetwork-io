...
const metaImage =
  "https://tvuqvrbxusmicpmjqpus.supabase.co/storage/v1/render/image/public/site_images/studio.jpg";
...
function page() {
  return (
    <div className="relative">
      ...
      <div
        id="faq"
        className="max-w-screen mx-auto border-t border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-black"
      >
